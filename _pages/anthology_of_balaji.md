---
layout:     page
title:      The Anthology of Balaji by Eric Jorgenson
...
- **The Impact of Technology    - Technology Lowers Prices
    - Technology Is the Driving Force of History
    - Technology Determines Political Order
    - From Centralized to Decentralized
- **Our Digital Future    - Physical, Then Digital, Then Native Digital
    - The Blockchain Disruption
    - Technology to Create Alignment
    - The Digital Frontier
    - All Value Becomes Digital
- **Our Physical Future    - Automation Delivers Abundance
...
- **The Types of Truth    - Scientific Truth
    - Technical Truth
    - Political Truth
    - Economic Truth
    - Cryptographic Truth
- **Protecting the Truth    - Modern Media Is Misaligned with Truth
    - You Are What You See
    - The True Nature of Legacy Media
    - The NYT Said Rockets Could Never Work
    - Media Has Its Own Motives
- **How to Realign Media    - Creating High-Value Media
    - Media Driven by the Reader's Benefit
    - Aligning Incentives for Writers
- **Building a Fact-Based Media    - How Media Gets Us to Mars
    - Building a Better Truth Machine
    - Social Media Is a Huge Vat of Brains
    - How New Technologies Shape Communication
- **The Future of Media is Decentralized    - Creating Pre-Narrative News
...
- **Believing    - Adopt a Mindset of Abundance
...
- **Founding    - Researching
    ...
    - Executing
    - Surviving
- **Evolving    - The Productivity Playbook

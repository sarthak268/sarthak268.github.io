...
<div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="margin-bottom: 0;">
        ...
        <a href="https://scholar.google.com/citations?hl=en&user=SLRQlXEAAAAJ&view_op=list_works&sortby=pubdate" target="_blank"><img src="./img/google_scholar.jpg" alt="Google Scholar" class="social-icon social-icon-color" style="width: 30px; height: 25px;"></a>
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-content">
            ...
            <ul class="timeline-details">
                ...
                <li>1x World Model (<a href="https://www.1x.tech/discover/world-model-self-learning">blog</a>) - a 14B parameter video generation model that imagines the future, then acts on it</li>
            </ul>
        </div>
    </div>
    <div class="timeline-item">

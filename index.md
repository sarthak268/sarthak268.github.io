    ...
    <div class="timeline-item">
        ...
        <div class="timeline-content">
            ...
            <ul class="timeline-details">
                ...
                <li>1x World Model (<a href="https://www.1x.tech/discover/world-model-self-learning">blog</a>) - video generation model that imagines the future, then acts on it</li>
            </ul>
        </div>
    </div>
    <div class="timeline-item">

...
<div class="row">
    ...
    <div class="col-sm-6 col-xs-12" style="margin-bottom: 0;">
        ...
        <a href="https://twitter.com/sarthak__bhagat"><img src="./img/twitter.jpg" alt="Twitter" style="width: 30px; height: 25px;"></a>
        <a href="https://github.com/sarthak268"><img src="./img/github.jpg" alt="GitHub" style="width: 30px; height: 30px;"></a>
        <a href="https://scholar.google.com/citations?hl=en&user=SLRQlXEAAAAJ&view_op=list_works&sortby=pubdate"><img src="./img/google_scholar.jpg" alt="Google Scholar" style="width: 30px; height: 30px;"></a>
    </div>
</div>
<hr>
